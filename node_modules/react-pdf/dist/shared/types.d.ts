import type { PasswordResponses, PDFDataRangeTransport, PDFDocumentProxy, PDFPageProxy } from 'pdfjs-dist';
import type { AnnotationLayerParameters } from 'pdfjs-dist/types/src/display/annotation_layer.js';
import type { DocumentInitParameters, RefProxy, StructTreeNode, TextContent, TextItem, TextMarkedContent, TypedArray } from 'pdfjs-dist/types/src/display/api.js';
